...
// New returns a new XM-430 registry
// See: https://emanual.robotis.com/docs/en/dxl/x/xm430-w350/
func init_xm430() reg.Map{
	x := 0
	...
	Registers := reg.Map{
		...
		reg.HighestLimitTemperature: {0x1f, 1, reg.RW, 0, 100},  // docs says not to set higher than default of 80C
		reg.MaxLimitVoltage:         {0x20, 2, reg.RW, 95, 160}, // volt = value*0.1
		reg.MinLimitVoltage:         {0x22, 2, reg.RW, 95, 160}, // volt = value*0.1
		reg.PWMLimit:                {0x24, 2, reg.RW, 0, 885}, // 0.113 [%]
		reg.CurrentLimit:            {0x26, 2, reg.RW, 0, 1193}, // 0.113 [%]
		...
		reg.GoalCurrent:           {0x66, 2, reg.RW, -1193, 1193},
		...
		reg.PresentCurrent:        {0x7e, 2, reg.RO, x, x},
